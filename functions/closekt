export async function onRequest(context) {
 ...
 request.headers.set("random", "1713710092000");
 ...
 request.headers.set("sign", "a293039b781bbd9b93a898de1841ac74b6de3160661524ce04fd6fab3003f88d");
 ...
 request.headers.set("Cookie", "acw_tc=2f624a7b17137198326528264e7eda0b4aee62b3acbf83d40e644cadd2f969");
   ...
   body: JSON.stringify({"reqId":"3fb009b659d1af634020b993193b05ce","stamp":1713710092000,"applianceCode":"210006723021912","command":{"control":{"power":"off","temperature":25,"small_temperature":0,"mode":"cool","wind_speed":102,"ptc":"off","ptc_force":"off","buzzer":"off","wind_swing_lr":"off","wind_swing_lr_under":"off","wind_swing_ud":"off"},"status":{"screen_display_now":"on","analysis_value":"power,mode,temperature,wind_speed,power_on_timer,smart_dry_value,power_off_timer,power_off_time_value,power_on_time_value,ptc,eco,dry,wind_swing_lr,wind_swing_lr_under,wind_swing_ud,kick_quilt,prevent_cold,small_temperature,purifier,dust_full_time,power_saving,fault_tag,indoor_temperature,comfort_power_save,fresh_filter_time_total,fresh_filter_time_use,fresh_filter_timeout","wind_speed":102,"small_temperature":0,"dry":"off","comfort_sleep":"off","error_code":0,"power_on_timer":"off","prevent_cold":"off","natural_wind":"off","indoor_temperature":24.1,"pmv":-3.5,"power_on_time_value":0,"mode":"cool","power_off_time_value":0,"wind_swing_lr_under":"off","wind_swing_ud":"off","fresh_filter_timeout":0,"eco":"off","purifier":"off","fault_tag":0,"dust_full_time":0,"ptc":"off","power_saving":"off","temperature":25,"strong_wind":"off","kick_quilt":"off","fresh_filter_time_total":0,"wind_swing_lr":"off","power":"on","power_off_timer":"off","fresh_filter_time_use":0,"comfort_power_save":"off","version":92}}}),
   redirect: 'follow'
})

  // 设置允许跨域的域名
     return new Response( "刘桐j 是个大聪明", {
